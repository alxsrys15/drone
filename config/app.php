...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'b556cdc5d150d8c34576405ae512603285466b7c8543a672678d098b2d8e9e4c'),
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'driver' => Mysql::class,
            'persistent' => false,
            'host' => 'localhost'/* 'sql288.main-hosting.eu' */,
            /*
            ...
            'username' => 'u925005881_root',
            'password' => 'VENGEANCE123',
            'database' => 'u925005881_drone',
            /*
